...
copyright = '2017, Shahriyar Rzayev'
...
latex_documents = [
    (master_doc, 'MySQLAutoXtrabackup.tex', 'MySQL AutoXtrabackup Documentation',
     'Shahriyar Rzayev', 'manual'),
]
...
man_pages = [
    (master_doc, 'mysqlautoxtrabackup', 'MySQL AutoXtrabackup Documentation',
     [author], 1)
]
